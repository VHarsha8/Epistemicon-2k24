         ...
         <div className="w-full overflow-x-auto">
           ...
           <thead>
                <tr class=" bg-darkgreytext ">
                    ...
                    <th class="border text-pearl  border-gray-400 px-4 py-2">Venue</th>
                    <th class="border text-pearl  border-gray-400 px-4 py-2">Faculty Co-ordinators</th>
                    <th class="border text-pearl border-gray-400 px-4 py-2">Student-Cordinators</th>
